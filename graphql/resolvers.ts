...
export const resolvers = {
  Query: {
    ...
    users: async (
      _: any,
      args: { orderBy?: { createdAt?: "asc" | "desc" } },
      context: Context,
    ) => {
    ...
    postsByOrganizationId: async (
      _: any,
      args: { orgId: number; filter: { type: "MONTH" | "QUARTER" | "YEAR" } },
      context: Context,
    ) => {
    ...
    postsBySpecificRecipient: async (
      _: any,
      args: {
        orgId: number;
        recipientId: number;
        filter: { type: "MONTH" | "QUARTER" | "YEAR" };
      },
      context: Context,
    ) => {
      let dateFilterStart, dateFilterEnd;
