                        ...
                        <Section>
                            <Row>
                                <Text className="text-base text-center">
                                    Great news! You've just received a new comment on your kudos, signaling appreciation and camaraderie from your team.
                                    Check it out and keep the positive vibes flowing!
                                </Text>
                            </Row>
                        </Section>

                        <Section className="text-center">
                            <Button className="bg-pink-500 text-white rounded-lg py-3 px-[18px]"
                                href={links}>
                                See new comments
                            </Button>
                        </Section>
