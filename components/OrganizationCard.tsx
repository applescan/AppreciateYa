...
const OrganizationCard: React.FC<OrganizationCardProps> = ({ organization, onEditClick }) => {
    return (
        <Card className="mt-2">
            <CardHeader className='pb-0'>
                ...
                <CardDescription>
                    <span className='text-xs flex gap-2 items-center'><HiOutlineOfficeBuilding className='text-gray-600' /> Address: {organization.address}</span>
                    <span className='text-xs flex gap-2 items-center'><MdWorkOutline className='text-gray-600' /> Type: {capitalizeEachWord(organization.organizationType)}</span>
                    <span className='text-xs flex gap-2 items-center'><HiOutlineGlobeEuropeAfrica className='text-gray-600' /> Country: {organization.country}</span>
                </CardDescription>
            </CardHeader>
